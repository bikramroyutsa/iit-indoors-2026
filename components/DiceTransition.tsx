...
export default function DiceTransition() {
  ...
  return (
    <section 
      ref={containerRef}
      className="relative h-[150vh] w-full overflow-hidden flex items-center justify-center pointer-events-none"
      style={{ backgroundColor: "#00110F" }}
    >
      <motion.div 
        className="sticky top-1/2 -translate-y-1/2 flex items-center justify-center w-full"
        style={{ opacity }}
      >
        {/* The Dice */}
        <motion.div 
